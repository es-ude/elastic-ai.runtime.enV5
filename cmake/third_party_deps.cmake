...
macro(add_runtime_c)
  ...
  if(NOT topicMatcher__hdrs)
    ...
    target_include_directories(
                topicMatcher__hdrs
                INTERFACE $<TARGET_PROPERTY:topicMatcher,
  ...
  if (NOT protocol__hdrs)
    ...
    target_include_directories(
                protocol__hdrs
                INTERFACE $<TARGET_PROPERTY:protocol,
                INTERFACE_INCLUDE_DIRECTORIES>
    )
  endif()
...
macro(add_freertos)
  ...
  target_include_directories(
            ...
            INTERFACE $<TARGET_PROPERTY:FreeRTOS-Kernel,
            INTERFACE_INCLUDE_DIRECTORIES>
  )
  ...
  target_include_directories(
            ...
            INTERFACE
            $<TARGET_PROPERTY:FreeRTOS-Kernel-Heap3,
            INTERFACE_INCLUDE_DIRECTORIES>
  )
