if(NOT TARGET _eai_runtime_pre_init_marker)
  ...
  set(EAI_RUNTIME_PATH
    ${CMAKE_CURRENT_LIST_DIR} CACHE PATH "Path to the EAI runtime" FORCE
  )
  ...
  macro(eai_runtime_init)
    if(NOT CMAKE_PROJECT_NAME)
      message(WARNING
        "eai_runtime_init() should be called after the project is created (and languages added)")
    endif()
    init_pico_sdk()
