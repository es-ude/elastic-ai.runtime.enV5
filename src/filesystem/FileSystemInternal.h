...
static void writeFileToSector(flashConfiguration_t *flashConfig,
                              filesystemConfiguration_t *filesystemConfig, uint8_t currentSector,
                              uint8_t newSector);
static void fileSystemEntryToByteArray(filesystemConfiguration_t *filesystemConfig,
...
static void reconstructEntry(filesystemConfiguration_t *filesystemConfig, uint8_t id, char name[],
                             uint8_t sector, uint32_t size, uint8_t isConfig,
                             uint8_t numberOfSectors);
static void updateEntrySector(filesystemConfiguration_t *filesystemConfig, uint8_t oldSector,
                              uint8_t newSector);
static void inc();
...
static void checkNumberOfEntries(flashConfiguration_t *flashConfig,
                                 filesystemConfiguration_t *filesystemConfig);
static void deleteFileSystemEntry(flashConfiguration_t *flashConfig,
