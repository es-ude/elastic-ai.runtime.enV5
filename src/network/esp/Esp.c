...
void espSetMqttReceiverFunction(void (*receive)(char *)) { uartSetMqttReceiverFunction(receive); }

void espSetHTTPReceiverFunction(void (*receive)(char *)) { uartSetHTTPReceiverFunction(receive); }
