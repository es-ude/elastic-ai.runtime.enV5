...
pac193xErrorCode_t pac193xRefreshData(pac193xSensorConfiguration_t sensor) {
  ...
  pac193xErrorCode_t errorCode = pac193xInternalSendRequestToSensor(sensor, PAC193X_CMD_REFRESH_V);
  if (errorCode != PAC193X_NO_ERROR) {
...
pac193xErrorCode_t pac193xGetSensorInfo(pac193xSensorConfiguration_t sensor,
  ...
  errorCode = pac193xInternalGetDataFromSensor(sensor, &info->manufacturer_id, sizeOfResponseBuffer,
...
pac193xErrorCode_t pac193xGetMeasurementsForChannel(pac193xSensorConfiguration_t sensor,
  ...
  errorCode = pac193xInternalGetData(sensor, channel, PAC193X_VSENSE, &measurements->voltageSense);
  if (errorCode != PAC193X_NO_ERROR) {
    measurements->voltageSource = 0;
    measurements->voltageSense = 0;
    measurements->currentSense = 0;
  ...
  errorCode = pac193xInternalGetData(sensor, channel, PAC193X_CURRENT, &measurements->currentSense);
  if (errorCode != PAC193X_NO_ERROR) {
    measurements->voltageSource = 0;
    measurements->voltageSense = 0;
    measurements->currentSense = 0;
