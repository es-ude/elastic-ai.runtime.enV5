 ...
 * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323GetRegister(bmi323SensorConfiguration_t *sensor, uint8_t address, data_t *data);
 ...
 * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323SetRegister(bmi323SensorConfiguration_t *sensor, uint8_t address, data_t *data);
 ...
 * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323EnableFeature(bmi323SensorConfiguration_t *sensor, bmi323Features_t *features);
 ...
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323SetSensorConfiguration(bmi323SensorConfiguration_t *sensor, uint8_t numberOfFeatures,
 ...
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323GetSensorConfiguration(bmi323SensorConfiguration_t *sensor, uint8_t numberOfFeatures,
                                  bmi323FeatureConfiguration_t *config);
 ...
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323GetInterruptConfig(bmi323SensorConfiguration_t *sensor, bmi323InterruptConfig_t *config);
 ...
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323SetInterruptConfig(bmi323SensorConfiguration_t *sensor, bmi323InterruptConfig_t *config);
 ...
 * @param[out] interruptState requested interrupt register
 *
 * @returns ErrorCode BMI323_OK See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323GetInterruptStatus(bmi323SensorConfiguration_t *sensor,
                                  bmi323InterruptRegister_t interruptRegister, uint16_t interruptState);
 ...
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
 bmi323ErrorCode_t bmi323GetRemappingOfAxes(bmi323SensorConfiguration_t *sensor, bmi323AxesRemap_t *remapping);
 ...
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
 bmi323ErrorCode_t bmi323SetRemappingOfAxes(bmi323SensorConfiguration_t *sensor, bmi323AxesRemap_t remapping);
 ...
 *
 * @param[in] sensor pointer to sensor struct holding the sensor configuration
 * @param[out] temperatureInDegreeCelsius pointer to float where the temperature in degree celsius will be stored
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323GetTemperature(bmi323SensorConfiguration_t *sensor, float *temperatureInDegreeCelsius);
 ...
 * @param[out] value pointer to float where the value in degree per second will be stored
 *
 * @return return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323LsbToDps(int16_t rawValue, uint8_t range, uint8_t resolution, float *value);
 ...
 * @param[in] resolution bit width of the raw value
 * @param[out] value pointer to float where the value in meter per second squared will be stored
 * @return return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323LsbToMps2(int16_t rawValue, uint8_t range, uint8_t resolution, float *value);
// end::prototypes_data[]
/* endregion DATA */
 ...
 *
 * @param[in] sensor pointer to sensor struct holding the sensor configuration
 * @param[out] configuration pointer to uint16_t where the configuration of the FIFO buffer will be stored
 *
 * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323GetFifoConfiguration(bmi323SensorConfiguration_t *sensor, uint16_t *configuration);
 ...
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323ExtractAcceleratorData(bmi323SensorConfiguration_t *sensor, bmi323FifoFrame_t *frame,
 ...
 * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323ExtractGyroscopeData(bmi323SensorConfiguration_t *sensor, bmi323FifoFrame_t *frame,
                                bmi323AxesData_t *data);
 ...
 *
  * @return             return the error code (0 if everything passed) - See #bmi323ErrorCode
 */
bmi323ErrorCode_t bmi323ExtractTemperatureData(bmi323SensorConfiguration_t *sensor, bmi323FifoFrame_t *frame,
