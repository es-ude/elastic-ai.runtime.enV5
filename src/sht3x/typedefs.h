...
enum
  {
    ...
    SHT3X_CMD_MEASURE_CLOCKSTRETCH_HIGH     = 0x2C06, /*!< measurement: clock stretching, high repeatability */
    SHT3X_CMD_MEASURE_CLOCKSTRETCH_MEDIUM   = 0x2C0D, /*!< measurement: clock stretching, medium repeatability */
    SHT3X_CMD_MEASURE_CLOCKSTRETCH_LOW      = 0x2C10, /*!< measurement: clock stretching, low repeatability */
    ...
    SHT3X_CMD_MEASURE_PERIODIC_05_HIGH      = 0x2032, /*!< measurement: periodic 0.5 mps, high repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_05_MEDIUM    = 0x2024, /*!< measurement: periodic 0.5 mps, medium repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_05_LOW       = 0x202F, /*!< measurement: periodic 0.5 mps, low repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_1_HIGH       = 0x2130, /*!< measurement: periodic 1 mps, high repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_1_MEDIUM     = 0x2126, /*!< measurement: periodic 1 mps, medium repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_1_LOW        = 0x212D, /*!< measurement: periodic 1 mps, low repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_2_HIGH       = 0x2236, /*!< measurement: periodic 2 mps, high repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_2_MEDIUM     = 0x2220, /*!< measurement: periodic 2 mps, medium repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_2_LOW        = 0x222B, /*!< measurement: periodic 2 mps, low repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_4_HIGH       = 0x2334, /*!< measurement: periodic 4 mps, high repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_4_MEDIUM     = 0x2322, /*!< measurement: periodic 4 mps, medium repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_4_LOW        = 0x2329, /*!< measurement: periodic 4 mps, low repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_10_HIGH      = 0x2737, /*!< measurement: periodic 10 mps, high repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_10_MEDIUM    = 0x2721, /*!< measurement: periodic 10 mps, medium repeatability */
    SHT3X_CMD_MEASURE_PERIODIC_10_LOW       = 0x272A, /*!< measurement: periodic 10 mps, low repeatability */
 ...
 *  \struct bits
 *
 * Defines the structure of the status register for a LITTLE_ENDIAN based machine
 */
typedef union
  {
