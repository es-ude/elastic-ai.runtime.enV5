...
size_t flashGetBytesPerPage(flashConfiguration_t *flashConfig) { return flashConfig->bytesPerPage; }

size_t flashGetBytesPerSector(flashConfiguration_t *flashConfig) {
  return flashConfig->bytesPerSector;
}

size_t flashGetNumberOfBytes(flashConfiguration_t *flashConfig) { return flashConfig->size; }
