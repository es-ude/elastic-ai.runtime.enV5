...
# This can be dropped into an external project to help locate the elastic-ai runtime
...
set(EAI_RUNTIME_PATH "${EAI_RUNTIME_PATH}" CACHE PATH "Path to the EAI runtime")
set(EAI_RUNTIME_FETCH_FROM_GIT "${EAI_RUNTIME_FETCH_FROM_GIT}" CACHE BOOL "Set to ON to fetch copy of SDK from git if not otherwise locatable")
set(EAI_RUNTIME_FETCH_FROM_GIT_PATH "${EAI_RUNTIME_FETCH_FROM_GIT_PATH}" CACHE FILEPATH "location to download runtime")
set(EAI_RUNTIME_FETCH_FROM_GIT_TAG "${EAI_RUNTIME_FETCH_FROM_GIT_TAG}" CACHE FILEPATH "release tag for runtime")
...
if (NOT EXISTS ${EAI_RUNTIME_INIT_CMAKE_FILE})
    message(FATAL_ERROR "Directory '${EAI_RUNTIME_PATH}' does not appear to contain the EAI runtime")
endif ()

set(EAI_RUNTIME_PATH ${EAI_RUNTIME_PATH} CACHE PATH "Path to the EAI runtime" FORCE)
