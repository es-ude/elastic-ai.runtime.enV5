...
void testMessageContentDynamicallyChangedBeforeEnqueueing() {
...
void testQueueOverflowAfterMaxSizeReached() {
    message_t message;
...
void testRunnerTask() {
    ...
    RUN_TEST(testBasicMessageExchange);
    RUN_TEST(testMessageContentDynamicallyChangedBeforeEnqueueing);
