 ...
 * @param sclGPIO
 */
void I2C_Init(i2c_inst_t *i2cHost, uint32_t baudrate, uint8_t sdaGPIO,
              uint8_t sclGPIO) {}
...
I2C_ErrorCode (*I2C_WriteCommand_ptr)(const uint8_t *commandBuffer,
                                      uint16_t sizeOfCommandBuffer,
                                      uint8_t slaveAddress,
                                      i2c_inst_t *i2cHost);

I2C_ErrorCode I2C_WriteCommand(const uint8_t *commandBuffer,
                               uint16_t sizeOfCommandBuffer,
                               uint8_t slaveAddress, i2c_inst_t *i2cHost) {
    return I2C_WriteCommand_ptr(commandBuffer, sizeOfCommandBuffer,
                                slaveAddress, i2cHost);
}
...
I2C_ErrorCode (*I2C_ReadCommand_ptr)(uint8_t *readBuffer,
                                     uint8_t sizeOfReadBuffer,
                                     uint8_t slaveAddress, i2c_inst_t *i2cHos);

I2C_ErrorCode I2C_ReadData(uint8_t *readBuffer, uint8_t sizeOfReadBuffer,
                           uint8_t slaveAddress, i2c_inst_t *i2cHost) {
    return I2C_ReadCommand_ptr(readBuffer, sizeOfReadBuffer, slaveAddress,
                               i2cHost);
}

I2C_ErrorCode I2C_ReadCommand_Hardware_defect(uint8_t *readBuffer,
                                              uint8_t sizeOfReadBuffer,
                                              uint8_t slaveAddress,
                                              i2c_inst_t *i2cHost) {
    return I2C_INIT_ERROR;
...
I2C_ErrorCode I2C_ReadCommand_ACK_missing(uint8_t *readBuffer,
                                          uint8_t sizeOfReadBuffer,
                                          uint8_t slaveAddress,
                                          i2c_inst_t *i2cHost) {
    return I2C_ACK_ERROR;
...
I2C_ErrorCode I2C_ReadCommand_Pass_for_SHT3X(uint8_t *readBuffer,
                                             uint8_t sizeOfReadBuffer,
                                             uint8_t slaveAddress,
                                             i2c_inst_t *i2cHost) {
    /**
...
I2C_ErrorCode I2C_ReadCommand_provoke_checksum_fail_for_SHT3X(
    uint8_t *readBuffer, uint8_t sizeOfReadBuffer, uint8_t slaveAddress,
    i2c_inst_t *i2cHost) {
    /**
...
I2C_ErrorCode I2C_ReadCommand_Pass_for_ADXL345B(uint8_t *readBuffer,
                                                uint8_t sizeOfReadBuffer,
                                                uint8_t slaveAddress,
                                                i2c_inst_t *i2cHost) {
    /* generate sample data without any real world connection to test
...
I2C_ErrorCode I2C_ReadCommand_Pass_for_PAC193X(uint8_t *readBuffer,
                                               uint8_t sizeOfReadBuffer,
                                               uint8_t slaveAddress,
                                               i2c_inst_t *i2cHost) {
    /* generate sample data without any real world connection to test
