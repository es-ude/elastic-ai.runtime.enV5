...
void unitTestConv1dBackward() {
    ...
    float expectedPropagatedLoss1[inputSize] = {-0.8333f, -0.6667f, -1.0000f, -0.8333f, 0.1667f,
                                                -0.1667f,
    ...
    float expectedPropagatedLoss2[inputSize] = {-0.8333f, -0.6667f, -1.0000f, -0.8333f, 0.1667f,
                                                -0.1667f,
                                                -1.3333f, -0.3333f, 0.6667f, 0.3333f, -0.1667f,
                                                -0.8333f};
